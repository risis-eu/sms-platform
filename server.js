...
const publicRoutes = ['/', '/about', '/contact', '/datasets', '/demos', 'geojsonDump', '/boundariesMap', '/dataIngestion', '/conceptualModel', '/ldServices', '/usecases', '/usecase_analyzing_change_in_research_system', '/usecase_study_links_between_organizations', '/usecase_flexible_urban_areas_innovation', '/usecase_universities_environemnt_relation_performance', '/usecase_evaluating_research_portfolios', '/api_documentation'];
