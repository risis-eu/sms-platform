...
class DatasetMetadataResource extends React.Component {
    constructor(props) {
        super(props);
    }
    componentDidMount() {
    ...
    render() {
        ...
        return (
            <div className="ui page grid" ref="DatasetMetadataResource" itemScope itemType={this.props.resourceType} itemID={this.props.resource}>
...
DatasetMetadataResource.contextTypes = {
    executeAction: React.PropTypes.func.isRequired,
    getUser: React.PropTypes.func
};
export default DatasetMetadataResource;
