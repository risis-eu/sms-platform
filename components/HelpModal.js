                  ...
                  <div className="ui divided list">
                      ...
                      <div className="item">
                        <div className="content">
                          ...
                          <div className="description"> <i className="big icon black database"></i> Read Only Access <i className="big icon green database"></i> Write Access <i className="big icon yellow database"></i> Partial Write Access </div>
                        </div>
                      </div>
                    </div>
                </div>
