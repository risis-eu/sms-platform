...
export default {
    ...
    create: (req, resource, params, body, config, callback) => {
        ...
        //adds ld-r annotations to a resource for a certain property if set
            ...
            getDynamicEndpointParameters(user, targetDataset, (endpointParameters)=>{
                graphName = endpointParameters.graphName;
                query = queryObject.getPrefixes() + queryObject.geoEnrichResource(endpointParameters, user, targetDataset, graphName, params.resource, propertyURI, params.enrichment, params.inNewDataset);
                //console.log(query);
                //build http uri
                //send request
                HTTPQueryObject = getHTTPQuery('update', query, endpointParameters, outputFormat);
